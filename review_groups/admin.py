...
Each group can be created by any user,
  and movies can be added by users who are members of the respective group.

Attributes:
    - list_display (tuple):
      Fields displayed in the list view.
    - search_fields (tuple):
      Fields available for search in the admin interface.
    - fieldsets (tuple):
      Grouped fields displayed in the group detail view.

Usage:
    - This admin module manages review groups.
    - Users can add movies to groups if they
      are members of the respective group.
"""

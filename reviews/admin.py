...
This admin module provides an interface for
handling reviews submitted by users.
...
Attributes:
    ...
    - fieldsets (tuple): Defines the structure and grouping
      of fields in the admin interface.

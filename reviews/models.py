...
class Review(models.Model):
    ...
    Attributes:
        ...
        - review_user (ForeignKey): User providing the review, linked to the CustomUser model.
        - review_movie (ForeignKey): Movie being reviewed, linked to the MovieDetails model.
        - review_group (ForeignKey): Group associated with the review, linked to the ReviewGroups model (nullable).
